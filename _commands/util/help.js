...
const command = {}
command.data = new SlashCommandBuilder().setName('help').setDescription('Helo im under the water please help me')
command.execute = async (interaction) => {
  ...
  collector.on("end", () => {
    interaction.editReply({ content: "", components: [] }).catch(err => interaction.client.handleError(interaction, err)).catch(err => interaction.client.handleError(interaction, err))
  })
